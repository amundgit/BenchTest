...
public interface PositionRepository extends CrudRepository<Position, Integer>{
    ...
    @Query("SELECT p FROM Position p WHERE date_collected = :date AND companyName = :companyName AND positionDuration = :positionDuration AND positionName = :positionName AND noOfPositions = :noOfPositions AND field = :field")
